...
class JwtAuthenticationFilter(
    ...
    private fun updateContext(founder: UserDetails, request: HttpServletRequest) {
        val authToken = UsernamePasswordAuthenticationToken(founder, null, founder.authorities)
